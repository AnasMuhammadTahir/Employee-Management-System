...
import { Menu, X, Home, User, Calendar, Settings, FileText, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {open && (
        <div className="fixed inset-0 z-40 bg-white flex flex-col lg:hidden">
          ...
          <nav className="flex-1 px-4 py-4 space-y-1">
            ...
            <NavLink to="/employee/payslips" className={linkClasses} onClick={() => setOpen(false)}>
      ...
      <aside className="hidden lg:flex w-64 bg-white shadow-lg flex-col border-r">
        ...
        <nav className="px-4 space-y-1 flex-1">
          ...
          <NavLink to="/employee/payslips" className={linkClasses}>
            <FileText size={20} className="mr-3" />
            Payslips
          </NavLink>
        ...
        <div className="lg:hidden bg-white shadow-sm p-4 border-b">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-800">StaffNet</h2>
